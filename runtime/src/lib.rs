...
use sp_runtime::{
	...
	traits::{
		self, BlakeTwo256, Block as BlockT, IdentifyAccount, NumberFor, OpaqueKeys,
...
pub use frame_support::{
	...
	parameter_types,
	traits::{
		ConstU16, Currency, Everything, Get, Imbalance, KeyOwnerProofSystem, OnUnbalanced,
...
parameter_types! {
	pub const IndexDeposit: Balance = SCV;
}
...
parameter_types! {
	...
	pub const ProposalBondMinimum: Balance = 100 * SCV;
	pub const SpendPeriod: BlockNumber = 24 * DAYS;
	pub const Burn: Permill = Permill::from_percent(1);
	pub const TipCountdown: BlockNumber = 1 * DAYS;
	pub const TipFindersFee: Percent = Percent::from_percent(20);
	pub const TipReportDepositBase: Balance = 1 * SCV;
	pub const DataDepositPerByte: Balance = 1 * CENTS;
	pub const BountyDepositBase: Balance = 1 * SCV;
	pub const BountyDepositPayoutDelay: BlockNumber = 8 * DAYS;
	pub const TreasuryPalletId: PalletId = PalletId(*b"py/trsry");
	pub const BountyUpdatePeriod: BlockNumber = 90 * DAYS;
	pub const MaximumReasonLength: u32 = 16384;
	pub const BountyCuratorDeposit: Permill = Permill::from_percent(50);
	pub const BountyValueMinimum: Balance = 10 * SCV;
	pub const MaxApprovals: u32 = 100;
	pub const MaxActiveChildBountyCount: u32 = 5;
	pub const ChildBountyValueMinimum: Balance = 1 * SCV;
	pub const CuratorDepositMax: Balance = 100 * SCV;
	pub const CuratorDepositMin: Balance = 10 * SCV;
...
parameter_types! {
	...
	// 40 SCVs fixed deposit..
	pub const SignedDepositBase: Balance = deposit(2, 0);
	// 0.01 SCV per KB of solution data.
...
impl hierarchy_system::Config for Runtime {
	type Event = Event;
	type CheckRole = Account;
}
...
impl_runtime_apis! {
	...
	impl pallet_cv_rpc_runtime_api::CvApi<Block> for Runtime{
		fn get_cv()->Vec<Item>{
			Cv::get_cv()
		}
	}
